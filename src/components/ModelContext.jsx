...
export const models = [
    ...
    { name: 'Sweater', path: '/sweater_model.glb', geometry: 'Object_4', material: 'WORLD_ZIP_HOODIE', x: 0.0006313540321818045, y: 0.0006313540321818045, z: 0.0006313540321818045, position: [0, 0, 0]},
